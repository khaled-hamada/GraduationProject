...
if("TRUE" STREQUAL "TRUE")
  set(imu_calib_SOURCE_PREFIX /home/khaled/baymax_ws2/src/imu_calib)
  set(imu_calib_DEVEL_PREFIX /home/khaled/baymax_ws2/devel)
  ...
  set(imu_calib_INSTALL_PREFIX /home/khaled/baymax_ws2/install)
...
if(NOT "/home/khaled/baymax_ws2/src/imu_calib/include;/usr/include/eigen3 " STREQUAL " ")
  set(imu_calib_INCLUDE_DIRS "")
  set(_include_dirs "/home/khaled/baymax_ws2/src/imu_calib/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/khaled/baymax_ws2/src/imu_calib/${idir}'.  ${_report}")
    endif()
...
set(depends "cmake_modules;roscpp;sensor_msgs;baymax_msgs")
