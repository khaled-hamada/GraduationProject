...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actionlib_t-msg:<FibonacciResult> is deprecated: use actionlib_t-msg:FibonacciResult instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actionlib_t-msg:sequence-val is deprecated.  Use actionlib_t-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FibonacciResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result ~%int32[] sequence ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FibonacciResult)))
  "Returns full string definition for message of type 'FibonacciResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result ~%int32[] sequence ~%~%~%"))
